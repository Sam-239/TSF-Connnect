...
//  TSF Social
//
//  Created by Syamantak Dhavle on 23/06/19.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        TWTRTwitter.sharedInstance().start(withConsumerKey:"jMFk4V3RCRPq0svaEpbum5LCQ", consumerSecret:"vju5WvjtQrSQIQYrpBRYd5ADoDLvmb08t6DV7c39BB9oPtzzRr");
        return true
    }
    func application(_ application:UIApplication, open url: URL, options: [UIApplication.OpenURLOptionsKey: Any]) -> Bool {
        ...
        return  directedByTWTR || directedByFB
    }
